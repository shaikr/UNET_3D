...
import os
from fetal_net.metrics import dice_coefficient, vod_coefficient, get_surface_distances, \
...
for exp in all_rel_exps:
    ...
    for sub_id in sub_ids:
        ...
        cur_dice = dice_coefficient(truth, binary_pred)
        cur_vo = vod_coefficient(truth, binary_pred)
